...
def apply_transform(data, n: int):
    ...
    for i in range(n, len(data)):
        try:
            input_sequence = data.iloc[i-n:i].values  # Use iloc for integer indexing and extract values
...
def main():
    ...
    # Prediction and Evaluation (Modified to reshape the actual_value array)
    ...
    for i in range(days + 1): 
        ...
        if i < len(test):
            ...
            # Reshape actual_value to be compatible with last_sequence
